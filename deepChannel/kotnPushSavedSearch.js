 ...
 */
define(["require", "exports", "N/crypto", "N/encode", "N/file", "N/https", "N/log", "N/runtime", "N/search", "N/util", "N/xml", "hmac", "encB"], function (require, exports, crypto, encode, file, http, log, runtime, search, util, xml, CryptoJS, addEnc) {
    Object.defineProperty(exports, "__esModule", { value: true });
    addEnc(CryptoJS);
    var S3PartsPush = /** @class */ (function () {
        function S3PartsPush(filename) {
            this.chunkCount = 0;
            this.uploadId = null;
            this.parts = [];
            this.filename = filename;
        }
        S3PartsPush.prototype.getUploadContext = function () {
    ...
    function execute(ctx) {
        ...
        pagedResults.pageRanges.forEach(function (pageRange) {
            ...
            if (lineLimit && linesReported >= lineLimit)
                return;
            ...
            myPage.data.forEach(function (result) {
                ...
                linesReported++;
                var lineData = (cols.map(function (c) {
