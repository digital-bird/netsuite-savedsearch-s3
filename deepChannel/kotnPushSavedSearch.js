 ...
 */
define(["require", "exports", "N/log", "N/record", "N/runtime", "N/search", "N/task", "./kotnHandleS3Push"], function (require, exports, log, record, runtime, search, task, s3Push) {
    ...
    function execute(ctx) {
        ...
        if (deferredDeployment) {
            ...
            var filters = [];
            if (deferredFolder) {
                if (deferredFolder.indexOf('/') != -1)
                    folderPath = deferredFolder;
                else {
                    ...
                    while (nextParentId) {
                        ...
                        pathParts.unshift(parentFolder.getValue({ fieldId: 'name' }));
